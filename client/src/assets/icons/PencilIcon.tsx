...
interface PencilIconProps extends SvgPropsType {}

const PencilIcon = (attribute: PencilIconProps) => {
  return (
    <svg aria-hidden="true" width="48" height="48" viewBox="0 0 48 48" {...attribute}>
      <path
