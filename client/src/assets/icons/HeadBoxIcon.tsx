...
interface HeadBoxIcon extends SvgPropsType {}

const HeadBoxIcon = (attribute: HeadBoxIcon) => {
  return (
    <svg width={20} height={20} viewBox="0 0 20 18" {...attribute}>
